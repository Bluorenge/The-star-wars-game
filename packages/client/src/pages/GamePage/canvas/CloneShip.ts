...
import cloneSheepPic from 'assets/img/cel.png';
...
const explo = [bum1, bum2, bum3, bum4, bum5, bum6];
...
export class CloneShip extends Entity {
  ...
  setUnVisible() {
    ...
    const interval = setInterval(() => {
      frameIndex++;
      if (frameIndex < 6) picLoad.src = explo[frameIndex];
