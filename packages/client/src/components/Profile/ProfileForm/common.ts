...
export const messages = defineMessages({
  ...
  buttonChangeProfileInfo: {
    id: 'profile.button.change-profile-info',
  ...
  labelDisplayName: {
    ...
    defaultMessage: 'Display nameƒ',
  },
  labelEmail: { id: 'profile.form.label.email', defaultMessage: 'Email' },
  labelFirstName: {
    id: 'profile.form.label.first-name',
    defaultMessage: 'First name',
  },
  labelLogin: { id: 'profile.form.label.login', defaultMessage: 'Login' },
  labelPhone: { id: 'profile.form.label.phone', defaultMessage: 'Phone' },
  labelSecondName: {
    id: 'profile.form.label.second-name',
    defaultMessage: 'Second name',
  },
  placeholderDisplayName: {
    id: 'profile.form.placeholder.display-name',
    defaultMessage: 'Display name',
  },
  placeholderEmail: {
    id: 'profile.form.placeholder.email',
  ...
  placeholderLogin: {
    id: 'profile.form.placeholder.login',
    defaultMessage: 'Login',
  },
  placeholderPhone: {
    id: 'profile.form.placeholder.phone',
